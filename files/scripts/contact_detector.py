...
if __name__ == "__main__":
    ...
    cage1_event_listener = PerchEventListener('manna,hou,bisnap','perch_sensor',bird=1 )
    cage2_event_listener = PerchEventListener('manna,hou,bisnap','perch_sensor',bird=2 )
